	...
	<script>
		...
		//		onLoadSuccess:handlerExp(),
				...
				columns:[[
					...
					{field:'jiatingdizhi',title:'家庭地址',width:200,align:'center'},
					{field:'panjueriqi',title:'判决日期',width:200,align:'center'},
					{field:'yuanpanxingqi',title:'原判刑期',width:200,align:'center'},
					{field:'qiri',title:'起日',width:200,align:'center'},
					{field:'zhiri',title:'止日',width:200,align:'center'},
					{field:'bozhengnianxian',title:'剥政年限
',width:200,align:'center'},
					{field:'zhengjianleixing',title:'证件类型',width:200,align:'center'},
					{field:'hunyinzhuangkuang',title:'婚姻状况
',width:200,align:'center'},
					{field:'guoji',title:'国籍',width:200,align:'center'},
					{field:'hujidi',title:'户籍地',width:200,align:'center'},
					{field:'rusuoriqi',title:'入所日期',width:200,align:'center'},
					{field:'rusuoxingzhi',title:'入所性质',width:200,align:'center'},
					{field:'guanyaqixian',title:'关押期限',width:200,align:'center'},
					{field:'chusuoshijian',title:'出所时间',width:200,align:'center'},
					{field:'chusuoyuanyin',title:'出所原因',width:200,align:'center'},
					{field:'xianzhudi',title:'现住地',width:200,align:'center'},
					{field:'chusuoquxiang',title:'出所去向',width:200,align:'center'},
					{field:'lijianriqi',title:'离监日期',width:200,align:'center'},
					{field:'lijianquxiang',title:'离监去向',width:200,align:'center'},
					{field:'fanhao',title:'番号',width:200,align:'center'},
		...
		function subSearch(){
			...
			$("#tt").datagrid("options").url='listInPersonInfo';
		...
		function viewDetail(id){
			window.open("editInPersonInfo?id="+id); 
		}
		
		function del(id){
			if(confirm("是否确定删除？")){
				$.post("deleteInPersonInfo","id="+id,
